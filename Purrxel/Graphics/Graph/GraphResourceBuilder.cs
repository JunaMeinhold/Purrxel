namespace Purrxel.Graphics.Graph
{
    ...
    public class GraphResourceBuilder : IGraphResourceBuilder
    {
        ...
        {
            UpdateResource(name, description, (desc) => new DepthStencil(description, name), depthStencilBuffers);
        }
        ...
        {
            UpdateResource(name, description, (desc) => new GBuffer(description, name), gBuffers);
        }
        ...
        {
            UpdateResource(name, description, (desc) => new Texture1D(description, name), textures1d);
        }
        ...
        {
            UpdateResource(name, description, (desc) => new Texture2D(description, name), textures2d);
        }
        ...
        {
            UpdateResource(name, description, (desc) => new Texture3D(description, name), textures3d);
        }
        ...
        {
            UpdateResource(name, desc, (desc) => new(desc), samplerStates);
        }
        ...
        {
            UpdateResource(name, desc, (desc) => GraphicsPipelineState.Create(desc, name), graphicsPipelineStates);
        }

        public ResourceRef<GraphicsPipelineState> GetGraphicsPipelineState(string name)
        {
            return GetOrAddResource<GraphicsPipelineState>(name);
        }

        public void UpdateComputePipelineState(string name, ComputePipelineDesc desc)
        {
            UpdateResource(name, desc, (desc) => ComputePipelineState.Create(desc, name), computePipelineStates);
        }

        public ResourceRef<ComputePipeline> GetComputePipeline(string name)
        {
            return GetOrAddResource<ComputePipeline>(name);
        }

        public void UpdateResource<TType, TDesc>(string name, TDesc desc, Func<TDesc, TType> constructor, IList<TType> group) where TType : class, IDisposable
        {
            ...
            TType resource = resourceRef.Value = constructor(desc);

            group.Add(resource);
        }

        public ResourceRef<ComputePipelineState> CreateComputePipelineState(ComputePipelineDesc description, ResourceCreationFlags flags = ResourceCreationFlags.All)
        {
            return CreateResource(description.GetHashCode().ToString(), description, (desc) => ComputePipelineState.Create(desc), computePipelineStates, computePipelineDescriptors, flags);
        }

        public ResourceRef<ComputePipelineState> CreateComputePipelineState(string name, ComputePipelineDesc description, ResourceCreationFlags flags = ResourceCreationFlags.All)
        {
            return CreateResource(name, description, (desc) => ComputePipelineState.Create(desc), computePipelineStates, computePipelineDescriptors, flags);
        }
        ...
        {
            return CreateResource(name, description, (desc) => new DepthStencil(description, name), depthStencilBuffers, depthStencilBufferDescriptors, flags);
        }
        ...
        {
            return CreateResource(name, description, (desc) => new GBuffer(description, name), gBuffers, gBufferDescriptors, flags);
        }

        public ResourceRef<GraphicsPipelineState> CreateGraphicsPipelineState(GraphicsPipelineStateDescEx description, ResourceCreationFlags flags = ResourceCreationFlags.All)
        {
            string name = description.GetHashCode().ToString();
            return CreateResource(name, description, (desc) => GraphicsPipelineState.Create(desc), graphicsPipelineStates, graphicsPipelineStateDescriptors, flags);
        }

        public ResourceRef<GraphicsPipelineState> CreateGraphicsPipelineState(string name, GraphicsPipelineStateDescEx description, ResourceCreationFlags flags = ResourceCreationFlags.All)
        {
            return CreateResource(name, description, (desc) => GraphicsPipelineState.Create(desc), graphicsPipelineStates, graphicsPipelineStateDescriptors, flags);
        }

        public ResourceRef<SamplerState> CreateSamplerState(string name, SamplerStateDescription description, ResourceCreationFlags flags = ResourceCreationFlags.All | ResourceCreationFlags.GroupShared)
        {
            return CreateResource(name, description, (desc) => new(desc), samplerStates, samplerStateDescriptors, flags);
        }
        ...
        {
            return CreateResource(name, description, (desc) => new Texture1D(description, name), textures1d, textures1dDescriptors, flags);
        }
        ...
        {
            return CreateResource(name, description, (desc) => new Texture2D(description, name), textures2d, textures2dDescriptors, flags);
        }
        ...
        {
            return CreateResource(name, description, (desc) => new Texture3D(description, name), textures3d, textures3dDescriptors, flags);
        }

        public ResourceRef<TType> CreateResource<TType, TDesc>(string name, TDesc description, Func<TDesc, TType> constructor, IList<TType> group, IList<ResourceDescriptor<TDesc>> descriptors, ResourceCreationFlags flags) where TDesc : struct where TType : class, IDisposable
        {
            ...
            if ((flags & ResourceCreationFlags.LazyInit) == 0)
            {
                ...
                TType resource = (TType)(shared?.Ref.Value ?? constructor(description));
