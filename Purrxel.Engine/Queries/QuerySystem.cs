namespace Purrxel.Engine.Queries
{
    ...
    public class QuerySystem : ISceneSystem, IDisposable
    {
        ...
        {
            this.scene = scene;
            scene.GameObjectAdded += OnGameObjectAdded;
            scene.GameObjectRemoved += OnGameObjectRemoved;
        }
        ...
        private void OnGameObjectAdded(Scene sender, GameObject obj)
        {
            lock (queries)
            {
        ...
        private void OnGameObjectRemoved(Scene sender, GameObject obj)
        {
            lock (queries)
            {
                obj.ComponentAdded -= OnComponentAdded;
