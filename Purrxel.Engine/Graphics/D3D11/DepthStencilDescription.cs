namespace Purrxel.Engine.Graphics.D3D11
{
    ...
    public struct DepthStencilDescription : IEquatable<DepthStencilDescription>
    {
        ...
        /// </summary>
        [XmlAttribute]
        [DefaultValue(ComparisonFunc.LessEqual)]
        ...
        /// </summary>
        public static readonly DepthStencilDescription Always = new(true, DepthWriteMask.All, ComparisonFunc.Always);
        ...
        /// </summary>
        public static readonly DepthStencilDescription DefaultLess = new(true, DepthWriteMask.All, ComparisonFunc.Less);
        ...
        /// </summary>
        public static readonly DepthStencilDescription DepthReadEquals = new(true, DepthWriteMask.Zero, ComparisonFunc.Equal);
        ...
        /// <param name="depthWriteMask">Identify a portion of the depth-stencil buffer that can be modified by depth data.</param>
        /// <param name="depthFunc">A function that compares depth data against existing depth data. </param>
        public DepthStencilDescription(bool depthEnable, bool stencilEnable, DepthWriteMask depthWriteMask, ComparisonFunc depthFunc = ComparisonFunc.LessEqual)
        {
            DepthEnable = depthEnable;
            DepthWriteMask = depthWriteMask;
            DepthFunc = depthFunc;
        ...
        public static implicit operator DepthStencilDesc(DepthStencilDescription desc)
        {
