namespace Purrxel.Engine.Graphics.D3D11
{
    ...
    public partial struct SamplerStateDescription : IEquatable<SamplerStateDescription>
    {
        ...
        /// </summary>
        [DefaultValue(ComparisonFunc.Never)]
        [XmlAttribute]
        public ComparisonFunc ComparisonFunction = ComparisonFunc.Never;
        ...
        public static implicit operator SamplerDesc(SamplerStateDescription desc)
        {
            return new()
            {
                ...
                BorderColor_0 = desc.BorderColor.X,
                BorderColor_1 = desc.BorderColor.Y,
                BorderColor_2 = desc.BorderColor.Z,
                BorderColor_3 = desc.BorderColor.W,
                ComparisonFunc = desc.ComparisonFunction,
                Filter = desc.Filter,
