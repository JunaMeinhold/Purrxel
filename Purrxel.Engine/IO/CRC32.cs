...
namespace Purrxel.Engine.IO
{
    ...
    public static class CRC32
    {
        ...
        public static unsafe uint Crc32(uint crc, ReadOnlySpan<byte> buf)
        {
            int size = buf.Length;
            int index = 0;
            crc ^= ~0U; //0xFFFFFFFF
        ...
        public static unsafe uint Crc32(ReadOnlySpan<byte> buf)
        {
            int size = buf.Length;
            int index = 0;
            uint crc = 0xFFFFFFFF;
        ...
        public static unsafe uint Crc32(string str)
        {
            return Crc32(MemoryMarshal.AsBytes(str.AsSpan()));
        }
    }
}